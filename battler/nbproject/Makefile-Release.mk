...
${OBJECTDIR}/_ext/511e4115/battler_main.o: ../src/battler_main.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -DDOUBLEPRECISION -DNDEBUG -D_DISABLEFINEGRAINEDLOCKING -D_DISABLETEMPORALTRACE -D_HTCOLLECTSTATISTICS -D_LINUX -DGEN4_STATIC -I.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/battler_main.o ../src/battler_main.cpp
