...
uint32_t planner_max::generateSolution(const EnvironmentPossible& origin)
{
...
uint32_t planner_max::generateSolution(PkCU& cu, Evaluator& eval, const EnvironmentPossible& origin, size_t agentTeam, size_t* _nodesEvaluated, std::vector<PlannerResult>* results)
{
