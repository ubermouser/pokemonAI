...
TEST_F(FlinchStatusTest, Test_IronHeadCausesFlinch) {
    ...
    EXPECT_TRUE(flinch_state.wasBlocked(TEAM_B));
...
TEST_F(FlinchStatusTest, Test_FlinchWearsOff) {
    ...
    EXPECT_TRUE(flinch_state1.wasBlocked(TEAM_B));
    ...
    EXPECT_FALSE(env2.wasBlocked(TEAM_B));
